...
func TestTheForwarderHandsTheRequestToTheLeaderOnceWithItsMark(t *testing.T) {
	...
	forward := leaderForwarder(scriptedLeaderDiscovery{endpoint: viewstream.LeaderEndpoint{WorkerID: "pod-leader", Endpoint: endpoint}}, "pod-follower", nil)
	...
	forward = leaderForwarder(scriptedLeaderDiscovery{endpoint: viewstream.LeaderEndpoint{WorkerID: "pod-leader", Endpoint: strings.TrimPrefix(refusing.URL, "http://")}}, "pod-follower", nil)
	response = httptest.NewRecorder()
	...
	for _, miss := range viewstream.DiscoveryMissReasons {
		forward = leaderForwarder(scriptedLeaderDiscovery{miss: miss}, "pod-follower", nil)
	...
	forward = leaderForwarder(scriptedLeaderDiscovery{err: errors.New("redis: i/o timeout")}, "pod-follower", nil)
	...
	forward = leaderForwarder(scriptedLeaderDiscovery{endpoint: viewstream.LeaderEndpoint{WorkerID: "pod-gone", Endpoint: "127.0.0.1:1"}}, "pod-follower", nil)
	...
	if leaderForwarder(nil, "pod-follower", nil) != nil {
