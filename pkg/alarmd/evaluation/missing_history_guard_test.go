...
func TestMissingHistoryFromFullPersistsCurrentFactAndConvergesAfterReplay(t *testing.T) {
	...
	// The dependency holds data, none of it for this series: the per-series
	// missing point, guarded by the Level state written for the series.
	request.Inputs = []execution.SeriesEvaluationInputRequest{g4Input(t, request, map[string][]contract.CanonicalRecordV2{
		"primary": {g4Record(720, "80", nil)}, "previous": {g4OtherSeriesRecord(660, "100")}})}
